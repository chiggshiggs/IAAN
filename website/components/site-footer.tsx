  ...
  return (
    <footer className={cn(className)}>
      ...
      <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
        ...
        <p className="mt-2 text-sm text-gray-500">Indian Institute of Technology (Banaras Hindu University) Varanasi,India   </p>
        <p className="mt-2 text-sm text-gray-500">   PIN:221005</p>
      </div>
      ...
      <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <nav className="list-none mb-10">
            <li>
              <a className="text-gray-600 hover:text-gray-800">Ecell-Home</a>
            </li>
            <li>
              <a className="text-gray-600 hover:text-gray-800">Raise Funds</a>
            </li>
            <li>
              <a className="text-gray-600 hover:text-gray-800">Register as Investor</a>
            </li>
            <li>
              <a className="text-gray-600 hover:text-gray-800">I-AAN Team</a>
            </li>
                <li>
              <a className="text-gray-600 hover:text-gray-800">E-Cell Team</a>
            </li>
          </nav>
        </div>
